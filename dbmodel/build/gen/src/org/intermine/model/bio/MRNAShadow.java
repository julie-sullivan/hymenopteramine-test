...
public class MRNAShadow implements MRNA, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.MRNA.polypeptide
    protected java.util.Set<org.intermine.model.bio.Polypeptide> polypeptide = new java.util.HashSet<org.intermine.model.bio.Polypeptide>();
    public java.util.Set<org.intermine.model.bio.Polypeptide> getPolypeptide() { return polypeptide; }
    public void setPolypeptide(final java.util.Set<org.intermine.model.bio.Polypeptide> polypeptide) { this.polypeptide = polypeptide; }
    public void addPolypeptide(final org.intermine.model.bio.Polypeptide arg) { polypeptide.add(arg); }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("polypeptide".equals(fieldName)) {
            polypeptide = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        polypeptide = new ProxyCollection<org.intermine.model.bio.Polypeptide>(os, this, "polypeptide", org.intermine.model.bio.Polypeptide.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("polypeptide".equals(fieldName)) {
            polypeptide.add((org.intermine.model.bio.Polypeptide) element);
        } else if ("introns".equals(fieldName)) {
