...
public class CommentShadow implements Comment, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.Comment.publications
    ...
    @Override public String toString() { return "Comment [description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
