...
public class HomologueShadow implements Homologue, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Homologue.lastCommonAncestor
    protected java.lang.String lastCommonAncestor;
    public java.lang.String getLastCommonAncestor() { return lastCommonAncestor; }
    public void setLastCommonAncestor(final java.lang.String lastCommonAncestor) { this.lastCommonAncestor = lastCommonAncestor; }
    ...
    // Attr: org.intermine.model.bio.Homologue.clusterId
    protected java.lang.String clusterId;
    public java.lang.String getClusterId() { return clusterId; }
    public void setClusterId(final java.lang.String clusterId) { this.clusterId = clusterId; }
    ...
    @Override public String toString() { return "Homologue [clusterId=" + (clusterId == null ? "null" : "\"" + clusterId + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", homologue=" + (homologue == null ? "null" : (homologue.getId() == null ? "no id" : homologue.getId().toString())) + ", id=" + id + ", lastCommonAncestor=" + (lastCommonAncestor == null ? "null" : "\"" + lastCommonAncestor + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("lastCommonAncestor".equals(fieldName)) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("lastCommonAncestor".equals(fieldName)) {
            lastCommonAncestor = (java.lang.String) value;
        } else if ("type".equals(fieldName)) {
            type = (java.lang.String) value;
        } else if ("clusterId".equals(fieldName)) {
            clusterId = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (lastCommonAncestor != null) {
            sb.append("$_^alastCommonAncestor$_^");
            String string = lastCommonAncestor;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "alastCommonAncestor".equals(notXml[i])) {
                i++;
                ...
                lastCommonAncestor = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "aclusterId".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                clusterId = string == null ? notXml[i] : string.toString();
                i++;
            }
