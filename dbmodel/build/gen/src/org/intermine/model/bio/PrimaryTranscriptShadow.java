...
public class PrimaryTranscriptShadow implements PrimaryTranscript, ShadowClass
{
    public static final Class<PrimaryTranscript> shadowOf = PrimaryTranscript.class;
    // Attr: org.intermine.model.bio.PrimaryTranscript.mirbaseIdentifier
    ...
    // Col: org.intermine.model.bio.PrimaryTranscript.matureTranscripts
    protected java.util.Set<org.intermine.model.bio.MatureTranscript> matureTranscripts = new java.util.HashSet<org.intermine.model.bio.MatureTranscript>();
    public java.util.Set<org.intermine.model.bio.MatureTranscript> getMatureTranscripts() { return matureTranscripts; }
    public void setMatureTranscripts(final java.util.Set<org.intermine.model.bio.MatureTranscript> matureTranscripts) { this.matureTranscripts = matureTranscripts; }
    public void addMatureTranscripts(final org.intermine.model.bio.MatureTranscript arg) { matureTranscripts.add(arg); }

    // Attr: org.intermine.model.bio.Transcript.proteinIdentifier
    ...
    // Col: org.intermine.model.bio.Transcript.sequenceAlterations
    protected java.util.Set<org.intermine.model.bio.SequenceAlteration> sequenceAlterations = new java.util.HashSet<org.intermine.model.bio.SequenceAlteration>();
    public java.util.Set<org.intermine.model.bio.SequenceAlteration> getSequenceAlterations() { return sequenceAlterations; }
    public void setSequenceAlterations(final java.util.Set<org.intermine.model.bio.SequenceAlteration> sequenceAlterations) { this.sequenceAlterations = sequenceAlterations; }
    public void addSequenceAlterations(final org.intermine.model.bio.SequenceAlteration arg) { sequenceAlterations.add(arg); }
    ...
    @Override public boolean equals(Object o) { return (o instanceof PrimaryTranscript && id != null) ? id.equals(((PrimaryTranscript)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "PrimaryTranscript [biotype=" + (biotype == null ? "null" : "\"" + biotype + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=" + id + ", length=" + length + ", mirbaseIdentifier=" + (mirbaseIdentifier == null ? "null" : "\"" + mirbaseIdentifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", proteinIdentifier=" + (proteinIdentifier == null ? "null" : "\"" + proteinIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("mirbaseIdentifier".equals(fieldName)) {
            return mirbaseIdentifier;
        }
        if ("matureTranscripts".equals(fieldName)) {
            return matureTranscripts;
        }
        ...
        if ("sequenceAlterations".equals(fieldName)) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("matureTranscripts".equals(fieldName)) {
            matureTranscripts = (java.util.Set) value;
        ...
        } else if ("sequenceAlterations".equals(fieldName)) {
            sequenceAlterations = (java.util.Set) value;
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.PrimaryTranscriptShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        matureTranscripts = new ProxyCollection<org.intermine.model.bio.MatureTranscript>(os, this, "matureTranscripts", org.intermine.model.bio.MatureTranscript.class);
        ...
        sequenceAlterations = new ProxyCollection<org.intermine.model.bio.SequenceAlteration>(os, this, "sequenceAlterations", org.intermine.model.bio.SequenceAlteration.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("matureTranscripts".equals(fieldName)) {
            matureTranscripts.add((org.intermine.model.bio.MatureTranscript) element);
        } else if ("introns".equals(fieldName)) {
            ...
            sequenceAlterations.add((org.intermine.model.bio.SequenceAlteration) element);
        } else if ("overlappingFeatures".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("matureTranscripts".equals(fieldName)) {
            return org.intermine.model.bio.MatureTranscript.class;
        }
        if ("introns".equals(fieldName)) {
