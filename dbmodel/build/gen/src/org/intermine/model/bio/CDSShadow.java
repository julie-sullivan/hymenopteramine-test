...
public class CDSShadow implements CDS, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.CDS.hasEarlyStopCodon
    protected java.lang.String hasEarlyStopCodon;
    public java.lang.String getHasEarlyStopCodon() { return hasEarlyStopCodon; }
    public void setHasEarlyStopCodon(final java.lang.String hasEarlyStopCodon) { this.hasEarlyStopCodon = hasEarlyStopCodon; }

    // Attr: org.intermine.model.bio.CDS.proteinIdentifier
    ...
    @Override public String toString() { return "CDS [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", hasEarlyStopCodon=" + (hasEarlyStopCodon == null ? "null" : "\"" + hasEarlyStopCodon + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", proteinIdentifier=" + (proteinIdentifier == null ? "null" : "\"" + proteinIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", transcript=" + (transcript == null ? "null" : (transcript.getId() == null ? "no id" : transcript.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("hasEarlyStopCodon".equals(fieldName)) {
            return hasEarlyStopCodon;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("hasEarlyStopCodon".equals(fieldName)) {
            hasEarlyStopCodon = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (hasEarlyStopCodon != null) {
            sb.append("$_^ahasEarlyStopCodon$_^");
            String string = hasEarlyStopCodon;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "ahasEarlyStopCodon".equals(notXml[i])) {
                i++;
                ...
                hasEarlyStopCodon = string == null ? notXml[i] : string.toString();
                i++;
            }
