...
public class OrganismShadow implements Organism, ShadowClass
{
    ...
    @Override public String toString() { return "Organism [commonName=" + (commonName == null ? "null" : "\"" + commonName + "\"") + ", genus=" + (genus == null ? "null" : "\"" + genus + "\"") + ", id=" + id + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", shortName=" + (shortName == null ? "null" : "\"" + shortName + "\"") + ", species=" + (species == null ? "null" : "\"" + species + "\"") + ", taxonId=" + taxonId + "]"; }
