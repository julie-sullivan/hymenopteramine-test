...
public class PolypeptideShadow implements Polypeptide, ShadowClass
{
    public static final Class<Polypeptide> shadowOf = Polypeptide.class;
    // Attr: org.intermine.model.bio.Polypeptide.mrnaIdentifier
    protected java.lang.String mrnaIdentifier;
    public java.lang.String getMrnaIdentifier() { return mrnaIdentifier; }
    public void setMrnaIdentifier(final java.lang.String mrnaIdentifier) { this.mrnaIdentifier = mrnaIdentifier; }

    // Attr: org.intermine.model.bio.Polypeptide.geneIdentifier
    ...
    // Ref: org.intermine.model.bio.Polypeptide.mrna
    ...
    // Ref: org.intermine.model.bio.Polypeptide.gene
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("mrnaIdentifier".equals(fieldName)) {
            mrnaIdentifier = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.PolypeptideShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Polypeptide");
        if (mrnaIdentifier != null) {
            sb.append("$_^amrnaIdentifier$_^");
            String string = mrnaIdentifier;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "amrnaIdentifier".equals(notXml[i])) {
                i++;
                ...
                mrnaIdentifier = string == null ? notXml[i] : string.toString();
                i++;
            }
