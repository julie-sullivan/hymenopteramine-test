...
public class ChromosomeShadow implements Chromosome, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Chromosome.tertiaryIdentifier
    protected java.lang.String tertiaryIdentifier;
    public java.lang.String getTertiaryIdentifier() { return tertiaryIdentifier; }
    public void setTertiaryIdentifier(final java.lang.String tertiaryIdentifier) { this.tertiaryIdentifier = tertiaryIdentifier; }

    // Attr: org.intermine.model.bio.Chromosome.assembly
    protected java.lang.String assembly;
    public java.lang.String getAssembly() { return assembly; }
    public void setAssembly(final java.lang.String assembly) { this.assembly = assembly; }
    ...
    @Override public String toString() { return "Chromosome [assembly=" + (assembly == null ? "null" : "\"" + assembly + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", tertiaryIdentifier=" + (tertiaryIdentifier == null ? "null" : "\"" + tertiaryIdentifier + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("tertiaryIdentifier".equals(fieldName)) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("tertiaryIdentifier".equals(fieldName)) {
            tertiaryIdentifier = (java.lang.String) value;
        } else if ("assembly".equals(fieldName)) {
            assembly = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (tertiaryIdentifier != null) {
            sb.append("$_^atertiaryIdentifier$_^");
            String string = tertiaryIdentifier;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "atertiaryIdentifier".equals(notXml[i])) {
                i++;
                ...
                tertiaryIdentifier = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "aassembly".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                assembly = string == null ? notXml[i] : string.toString();
                i++;
            }
