...
public class IndelShadow implements Indel, ShadowClass
{
    public static final Class<Indel> shadowOf = Indel.class;
    // Attr: org.intermine.model.bio.Indel.validationStatus
    protected java.lang.String validationStatus;
    public java.lang.String getValidationStatus() { return validationStatus; }
    public void setValidationStatus(final java.lang.String validationStatus) { this.validationStatus = validationStatus; }

    // Attr: org.intermine.model.bio.Indel.referenceAllele
    protected java.lang.String referenceAllele;
    public java.lang.String getReferenceAllele() { return referenceAllele; }
    public void setReferenceAllele(final java.lang.String referenceAllele) { this.referenceAllele = referenceAllele; }

    // Attr: org.intermine.model.bio.Indel.heterozygosity
    protected java.lang.Float heterozygosity;
    public java.lang.Float getHeterozygosity() { return heterozygosity; }
    public void setHeterozygosity(final java.lang.Float heterozygosity) { this.heterozygosity = heterozygosity; }

    // Attr: org.intermine.model.bio.Indel.alternateAllele
    protected java.lang.String alternateAllele;
    public java.lang.String getAlternateAllele() { return alternateAllele; }
    public void setAlternateAllele(final java.lang.String alternateAllele) { this.alternateAllele = alternateAllele; }

    // Attr: org.intermine.model.bio.Indel.variationType
    protected java.lang.String variationType;
    public java.lang.String getVariationType() { return variationType; }
    public void setVariationType(final java.lang.String variationType) { this.variationType = variationType; }

    // Attr: org.intermine.model.bio.Indel.orientation
    protected java.lang.String orientation;
    public java.lang.String getOrientation() { return orientation; }
    public void setOrientation(final java.lang.String orientation) { this.orientation = orientation; }

    // Col: org.intermine.model.bio.SequenceAlteration.consequences
    protected java.util.Set<org.intermine.model.bio.Consequence> consequences = new java.util.HashSet<org.intermine.model.bio.Consequence>();
    public java.util.Set<org.intermine.model.bio.Consequence> getConsequences() { return consequences; }
    public void setConsequences(final java.util.Set<org.intermine.model.bio.Consequence> consequences) { this.consequences = consequences; }
    public void addConsequences(final org.intermine.model.bio.Consequence arg) { consequences.add(arg); }

    // Col: org.intermine.model.bio.SequenceAlteration.transcripts
    ...
    @Override public boolean equals(Object o) { return (o instanceof Indel && id != null) ? id.equals(((Indel)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Indel [alternateAllele=" + (alternateAllele == null ? "null" : "\"" + alternateAllele + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", heterozygosity=" + heterozygosity + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", orientation=" + (orientation == null ? "null" : "\"" + orientation + "\"") + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", referenceAllele=" + (referenceAllele == null ? "null" : "\"" + referenceAllele + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", validationStatus=" + (validationStatus == null ? "null" : "\"" + validationStatus + "\"") + ", variationType=" + (variationType == null ? "null" : "\"" + variationType + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("validationStatus".equals(fieldName)) {
            return validationStatus;
        }
        if ("referenceAllele".equals(fieldName)) {
            return referenceAllele;
        }
        if ("heterozygosity".equals(fieldName)) {
            return heterozygosity;
        }
        if ("alternateAllele".equals(fieldName)) {
            return alternateAllele;
        }
        if ("variationType".equals(fieldName)) {
            return variationType;
        }
        if ("orientation".equals(fieldName)) {
            return orientation;
        }
        if ("consequences".equals(fieldName)) {
            return consequences;
        }
        ...
        if (!org.intermine.model.bio.Indel.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("validationStatus".equals(fieldName)) {
            validationStatus = (java.lang.String) value;
        } else if ("referenceAllele".equals(fieldName)) {
            referenceAllele = (java.lang.String) value;
        } else if ("heterozygosity".equals(fieldName)) {
            heterozygosity = (java.lang.Float) value;
        } else if ("alternateAllele".equals(fieldName)) {
            alternateAllele = (java.lang.String) value;
        } else if ("variationType".equals(fieldName)) {
            variationType = (java.lang.String) value;
        } else if ("orientation".equals(fieldName)) {
            orientation = (java.lang.String) value;
        } else if ("consequences".equals(fieldName)) {
            consequences = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Indel.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Indel.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.IndelShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Indel");
        if (validationStatus != null) {
            sb.append("$_^avalidationStatus$_^");
            String string = validationStatus;
            while (string != null) {
        ...
        if (referenceAllele != null) {
            sb.append("$_^areferenceAllele$_^");
            String string = referenceAllele;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (heterozygosity != null) {
            sb.append("$_^aheterozygosity$_^").append(heterozygosity);
        }
        if (alternateAllele != null) {
            sb.append("$_^aalternateAllele$_^");
            String string = alternateAllele;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (variationType != null) {
            sb.append("$_^avariationType$_^");
            String string = variationType;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.IndelShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Indel)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "avalidationStatus".equals(notXml[i])) {
                i++;
                ...
                validationStatus = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "areferenceAllele".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                referenceAllele = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "aheterozygosity".equals(notXml[i])) {
                i++;
                heterozygosity = Float.valueOf(notXml[i]);
                i++;
            }
            if ((i < notXml.length) && "aalternateAllele".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                alternateAllele = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "avariationType".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                variationType = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "aorientation".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                orientation = string == null ? notXml[i] : string.toString();
                i++;
            }
        ...
        consequences = new ProxyCollection<org.intermine.model.bio.Consequence>(os, this, "consequences", org.intermine.model.bio.Consequence.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("consequences".equals(fieldName)) {
            consequences.add((org.intermine.model.bio.Consequence) element);
        } else if ("transcripts".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("consequences".equals(fieldName)) {
            return org.intermine.model.bio.Consequence.class;
        }
        if ("transcripts".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.Indel.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Indel.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
