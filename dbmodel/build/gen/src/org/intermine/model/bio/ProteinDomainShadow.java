...
public class ProteinDomainShadow implements ProteinDomain, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.ProteinDomain.identifier
    ...
    // Attr: org.intermine.model.bio.ProteinDomain.shortName
    ...
    // Col: org.intermine.model.bio.ProteinDomain.childFeatures
    protected java.util.Set<org.intermine.model.bio.ProteinDomain> childFeatures = new java.util.HashSet<org.intermine.model.bio.ProteinDomain>();
    public java.util.Set<org.intermine.model.bio.ProteinDomain> getChildFeatures() { return childFeatures; }
    public void setChildFeatures(final java.util.Set<org.intermine.model.bio.ProteinDomain> childFeatures) { this.childFeatures = childFeatures; }
    public void addChildFeatures(final org.intermine.model.bio.ProteinDomain arg) { childFeatures.add(arg); }

    // Col: org.intermine.model.bio.ProteinDomain.foundIn
    protected java.util.Set<org.intermine.model.bio.ProteinDomain> foundIn = new java.util.HashSet<org.intermine.model.bio.ProteinDomain>();
    public java.util.Set<org.intermine.model.bio.ProteinDomain> getFoundIn() { return foundIn; }
    public void setFoundIn(final java.util.Set<org.intermine.model.bio.ProteinDomain> foundIn) { this.foundIn = foundIn; }
    public void addFoundIn(final org.intermine.model.bio.ProteinDomain arg) { foundIn.add(arg); }

    // Col: org.intermine.model.bio.ProteinDomain.parentFeatures
    protected java.util.Set<org.intermine.model.bio.ProteinDomain> parentFeatures = new java.util.HashSet<org.intermine.model.bio.ProteinDomain>();
    public java.util.Set<org.intermine.model.bio.ProteinDomain> getParentFeatures() { return parentFeatures; }
    public void setParentFeatures(final java.util.Set<org.intermine.model.bio.ProteinDomain> parentFeatures) { this.parentFeatures = parentFeatures; }
    public void addParentFeatures(final org.intermine.model.bio.ProteinDomain arg) { parentFeatures.add(arg); }

    // Col: org.intermine.model.bio.ProteinDomain.contains
    protected java.util.Set<org.intermine.model.bio.ProteinDomain> contains = new java.util.HashSet<org.intermine.model.bio.ProteinDomain>();
    public java.util.Set<org.intermine.model.bio.ProteinDomain> getContains() { return contains; }
    public void setContains(final java.util.Set<org.intermine.model.bio.ProteinDomain> contains) { this.contains = contains; }
    public void addContains(final org.intermine.model.bio.ProteinDomain arg) { contains.add(arg); }

    // Col: org.intermine.model.bio.ProteinDomain.proteinDomainRegions
    ...
    @Override public String toString() { return "ProteinDomain [description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", shortName=" + (shortName == null ? "null" : "\"" + shortName + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("foundIn".equals(fieldName)) {
            return foundIn;
        }
        if ("parentFeatures".equals(fieldName)) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("foundIn".equals(fieldName)) {
            foundIn = (java.util.Set) value;
        } else if ("parentFeatures".equals(fieldName)) {
            parentFeatures = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        childFeatures = new ProxyCollection<org.intermine.model.bio.ProteinDomain>(os, this, "childFeatures", org.intermine.model.bio.ProteinDomain.class);
        foundIn = new ProxyCollection<org.intermine.model.bio.ProteinDomain>(os, this, "foundIn", org.intermine.model.bio.ProteinDomain.class);
        parentFeatures = new ProxyCollection<org.intermine.model.bio.ProteinDomain>(os, this, "parentFeatures", org.intermine.model.bio.ProteinDomain.class);
        contains = new ProxyCollection<org.intermine.model.bio.ProteinDomain>(os, this, "contains", org.intermine.model.bio.ProteinDomain.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("childFeatures".equals(fieldName)) {
            childFeatures.add((org.intermine.model.bio.ProteinDomain) element);
        } else if ("foundIn".equals(fieldName)) {
            foundIn.add((org.intermine.model.bio.ProteinDomain) element);
        } else if ("parentFeatures".equals(fieldName)) {
            parentFeatures.add((org.intermine.model.bio.ProteinDomain) element);
        } else if ("contains".equals(fieldName)) {
            contains.add((org.intermine.model.bio.ProteinDomain) element);
        } else if ("proteinDomainRegions".equals(fieldName)) {
