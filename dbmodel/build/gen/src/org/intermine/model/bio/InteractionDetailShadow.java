...
public class InteractionDetailShadow implements InteractionDetail, ShadowClass
{
    ...
    @Override public String toString() { return "InteractionDetail [confidence=" + confidence + ", confidenceText=" + (confidenceText == null ? "null" : "\"" + confidenceText + "\"") + ", experiment=" + (experiment == null ? "null" : (experiment.getId() == null ? "no id" : experiment.getId().toString())) + ", id=" + id + ", interaction=" + (interaction == null ? "null" : (interaction.getId() == null ? "no id" : interaction.getId().toString())) + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", relationshipType=" + (relationshipType == null ? "null" : "\"" + relationshipType + "\"") + ", role1=" + (role1 == null ? "null" : "\"" + role1 + "\"") + ", role2=" + (role2 == null ? "null" : "\"" + role2 + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
