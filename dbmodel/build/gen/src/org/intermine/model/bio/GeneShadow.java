...
public class GeneShadow implements Gene, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Gene.biotype
    protected java.lang.String biotype;
    public java.lang.String getBiotype() { return biotype; }
    public void setBiotype(final java.lang.String biotype) { this.biotype = biotype; }

    // Attr: org.intermine.model.bio.Gene.isBroken
    protected java.lang.String isBroken;
    public java.lang.String getIsBroken() { return isBroken; }
    public void setIsBroken(final java.lang.String isBroken) { this.isBroken = isBroken; }

    // Attr: org.intermine.model.bio.Gene.additionalIdentifiers
    protected java.lang.String additionalIdentifiers;
    public java.lang.String getAdditionalIdentifiers() { return additionalIdentifiers; }
    public void setAdditionalIdentifiers(final java.lang.String additionalIdentifiers) { this.additionalIdentifiers = additionalIdentifiers; }
    ...
    // Col: org.intermine.model.bio.Gene.duplicateEntities
    protected java.util.Set<org.intermine.model.bio.DuplicateEntity> duplicateEntities = new java.util.HashSet<org.intermine.model.bio.DuplicateEntity>();
    public java.util.Set<org.intermine.model.bio.DuplicateEntity> getDuplicateEntities() { return duplicateEntities; }
    public void setDuplicateEntities(final java.util.Set<org.intermine.model.bio.DuplicateEntity> duplicateEntities) { this.duplicateEntities = duplicateEntities; }
    public void addDuplicateEntities(final org.intermine.model.bio.DuplicateEntity arg) { duplicateEntities.add(arg); }
    ...
    // Col: org.intermine.model.bio.Gene.polypeptides
    protected java.util.Set<org.intermine.model.bio.Polypeptide> polypeptides = new java.util.HashSet<org.intermine.model.bio.Polypeptide>();
    public java.util.Set<org.intermine.model.bio.Polypeptide> getPolypeptides() { return polypeptides; }
    public void setPolypeptides(final java.util.Set<org.intermine.model.bio.Polypeptide> polypeptides) { this.polypeptides = polypeptides; }
    public void addPolypeptides(final org.intermine.model.bio.Polypeptide arg) { polypeptides.add(arg); }
    ...
    @Override public String toString() { return "Gene [additionalIdentifiers=" + (additionalIdentifiers == null ? "null" : "\"" + additionalIdentifiers + "\"") + ", biotype=" + (biotype == null ? "null" : "\"" + biotype + "\"") + ", briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", downstreamIntergenicRegion=" + (downstreamIntergenicRegion == null ? "null" : (downstreamIntergenicRegion.getId() == null ? "no id" : downstreamIntergenicRegion.getId().toString())) + ", id=" + id + ", isBroken=" + (isBroken == null ? "null" : "\"" + isBroken + "\"") + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", upstreamIntergenicRegion=" + (upstreamIntergenicRegion == null ? "null" : (upstreamIntergenicRegion.getId() == null ? "no id" : upstreamIntergenicRegion.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("biotype".equals(fieldName)) {
            return biotype;
        }
        if ("isBroken".equals(fieldName)) {
            return isBroken;
        }
        if ("additionalIdentifiers".equals(fieldName)) {
        ...
        if ("duplicateEntities".equals(fieldName)) {
        ...
        if ("polypeptides".equals(fieldName)) {
            return polypeptides;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("biotype".equals(fieldName)) {
            biotype = (java.lang.String) value;
        } else if ("isBroken".equals(fieldName)) {
            isBroken = (java.lang.String) value;
        } else if ("additionalIdentifiers".equals(fieldName)) {
            additionalIdentifiers = (java.lang.String) value;
        ...
        } else if ("duplicateEntities".equals(fieldName)) {
            duplicateEntities = (java.util.Set) value;
        ...
        } else if ("polypeptides".equals(fieldName)) {
            polypeptides = (java.util.Set) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (biotype != null) {
            sb.append("$_^abiotype$_^");
            String string = biotype;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (isBroken != null) {
            sb.append("$_^aisBroken$_^");
            String string = isBroken;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (additionalIdentifiers != null) {
            sb.append("$_^aadditionalIdentifiers$_^");
            String string = additionalIdentifiers;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "abiotype".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                biotype = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "aisBroken".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                isBroken = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "aadditionalIdentifiers".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                additionalIdentifiers = string == null ? notXml[i] : string.toString();
                i++;
            }
        ...
        duplicateEntities = new ProxyCollection<org.intermine.model.bio.DuplicateEntity>(os, this, "duplicateEntities", org.intermine.model.bio.DuplicateEntity.class);
        ...
        polypeptides = new ProxyCollection<org.intermine.model.bio.Polypeptide>(os, this, "polypeptides", org.intermine.model.bio.Polypeptide.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("flankingRegions".equals(fieldName)) {
            ...
            duplicateEntities.add((org.intermine.model.bio.DuplicateEntity) element);
        } else if ("introns".equals(fieldName)) {
            ...
            polypeptides.add((org.intermine.model.bio.Polypeptide) element);
        } else if ("regulatoryRegions".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("duplicateEntities".equals(fieldName)) {
            return org.intermine.model.bio.DuplicateEntity.class;
        }
        if ("introns".equals(fieldName)) {
        ...
        if ("polypeptides".equals(fieldName)) {
            return org.intermine.model.bio.Polypeptide.class;
        }
        if ("regulatoryRegions".equals(fieldName)) {
