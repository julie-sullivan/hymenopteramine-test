...
<table cellpadding="0" cellspacing="0" border="0" class="dbsources">
  ...
  <tr>
    <td rowspan="3"  class="leftcol"><p><h2>Ontology</h2></p></td>
    <td width="35%">
    ...
    <td>GO annotations</td>
      <td><a href="http://www.ebi.uniprot.org/index.shtml" target="_new" class="extlink">UniProt</a> <br>- Release 2014_10</td>
...
<td width="35%">
    ...
    <p><i>P. barbatus</i></p>
    <p><i>S. invicta</i></p>
    <p><i>W. auropunctata</i></p>

    </td>
    <td>GO ontology</td>
     <td><a href="http://www.geneontology.org" target="_new" class="extlink">Gene Ontology Site</a><br> -Sep 2014</td>
    <td> Gene Ontology Consortium - <a href="http://www.ncbi.nlm.nih.gov/pubmed/10802651" target="_new" class="extlink">PubMed:10802651</a></td>
    <td> &nbsp; </td>
  ...
  <tr>
    ...
    <td>SO ontology</td>
    <td><a href="http://www.sequenceontology.org/" target="_new" class="extlink">Sequence Ontology Site</a> -April 2015</td>
    <td> Eilbeck K et al - <a href="http://www.ncbi.nlm.nih.gov/pmc/articles/PMC1175956/" target="_new" class="extlink">PubMed:15892872</a></td>
    <td> &nbsp; </td>
  </tr>
<!--
  <tr>
